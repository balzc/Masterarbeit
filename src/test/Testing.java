...
public class Testing {
	...
	public void doTest(){
		...
		s.work("/users/balz/documents/workspace/data/interpolatedPrices.csv","/users/balz/documents/workspace/data/","/users/balz/documents/workspace/data/comp.csv", 20.,33,60.,28.,1.,5.,6,1000);
