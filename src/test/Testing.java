...
public class Testing {
	...
	public void doTest(){
		...
		s.work("/users/balz/documents/workspace/masterarbeit/data/noPeakPrices.csv","/users/balz/documents/workspace/masterarbeit/data/","/users/balz/documents/workspace/masterarbeit/data/comp.csv", 20.,33,60.,28.,1.,13.,6,0.5);
