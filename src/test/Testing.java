...
public class Testing {
	...
	public void doTest(){
		...
		s.work("/users/balz/documents/workspace/masterarbeit/data/adjustedPrices.csv","/users/balz/documents/workspace/masterarbeit/data/out.csv", 5000.,10.,20.,32.,34.,500.,44);
	}
